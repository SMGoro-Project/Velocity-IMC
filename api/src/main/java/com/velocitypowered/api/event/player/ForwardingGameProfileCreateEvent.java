...
public class ForwardingGameProfileCreateEvent {
   ...
   */
  public ForwardingGameProfileCreateEvent(Player player, RegisteredServer previousServer, RegisteredServer nextServer,
                                          List<GameProfile.Property> gameProfile) {
    this.player = player;
